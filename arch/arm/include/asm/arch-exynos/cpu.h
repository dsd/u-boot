...
/* GPIO */
#ifdef CONFIG_SMDKC220
#define	S5P_GPIO_RIGHT_BASE		0x11000000

#define	S5P_GPIO_CON			0x0
#define	S5P_GPIO_DAT			0x4
#define	S5P_GPIO_PUD			0x8

#define	S5P_GPL2_OFFSET			0x100
#define	S5P_GPX0_OFFSET			0xC00
#define	S5P_GPX1_OFFSET			0xC20
#define	S5P_GPX2_OFFSET			0xC40
#define	S5P_GPX3_OFFSET			0xC60

#define	S5P_GPL2_CON			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPL2_OFFSET+S5P_GPIO_CON)
#define	S5P_GPL2_DAT			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPL2_OFFSET+S5P_GPIO_DAT)
#define	S5P_GPL2_PUD			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPL2_OFFSET+S5P_GPIO_PUD)

#define	S5P_GPX0_CON			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX0_OFFSET+S5P_GPIO_CON)
#define	S5P_GPX0_DAT			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX0_OFFSET+S5P_GPIO_DAT)
#define	S5P_GPX0_PUD			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX0_OFFSET+S5P_GPIO_PUD)

#define	S5P_GPX1_CON			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX1_OFFSET+S5P_GPIO_CON)
#define	S5P_GPX1_DAT			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX1_OFFSET+S5P_GPIO_DAT)
#define	S5P_GPX1_PUD			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX1_OFFSET+S5P_GPIO_PUD)

#define	S5P_GPX2_CON			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX2_OFFSET+S5P_GPIO_CON)
#define	S5P_GPX2_DAT			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX2_OFFSET+S5P_GPIO_DAT)
#define	S5P_GPX2_PUD			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX2_OFFSET+S5P_GPIO_PUD)

#define	S5P_GPX3_CON			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX3_OFFSET+S5P_GPIO_CON)
#define	S5P_GPX3_DAT			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX3_OFFSET+S5P_GPIO_DAT)
#define	S5P_GPX3_PUD			__REG(S5P_GPIO_RIGHT_BASE+S5P_GPX3_OFFSET+S5P_GPIO_PUD)
#endif
