...
#endif
#define PART_SIZE_KERNEL	(16 * 1024 * 1024)
...
#endif
#define PART_SIZE_RKERNEL	(16 * 1024 * 1024)  // recovery kernel
#define PART_SIZE_RROOTFS	(32 * 1024 * 1024)  // recovery rootfs
...
#define MOVI_ZIMAGE_BLKCNT	(PART_SIZE_KERNEL / MOVI_BLKSIZE)	/* 16MB */
#define MOVI_ROOTFS_BLKCNT	(PART_SIZE_ROOTFS / MOVI_BLKSIZE)	/* 32MB */
#define MOVI_RZIMAGE_BLKCNT	(PART_SIZE_RKERNEL / MOVI_BLKSIZE)	/* 16MB */
#define MOVI_RROOTFS_BLKCNT	(PART_SIZE_RROOTFS / MOVI_BLKSIZE)	/* 32MB */
